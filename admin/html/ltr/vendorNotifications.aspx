  ...
  <div id="apDiv4">
    ...
    <div id="apDiv6">    
      <table width="100%" border="0">
        ...
        <tr>
          <th colspan="3" bgcolor="#141619" scope="row"><div align="left"><span class="style16">Vendor Notifications</span></div></th>
        </tr>
        <tr>
          <th colspan="3" scope="row">
              <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
                  ...
                  <Columns>
                      <asp:BoundField DataField="ns" HeaderText="Notification Subject" 
                          SortExpression="ns" />
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  SelectCommand="SELECT [ns], [description] FROM [vconfirm] WHERE ([vtype] = @vtype)">
                  <SelectParameters>
                      <asp:ControlParameter ControlID="Label3" Name="vtype" PropertyName="Text" 
                          Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
            </th>
