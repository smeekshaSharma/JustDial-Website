...
.style24 {font-size: 18px; color: #EF3C27; }
  ...
  <div id="apDiv2">
    <table width="100%" border="0">
      <tr>
        ...
        <th width="12%" bgcolor="#000000" class="style23" scope="col"><span class="style23">Login</span></th>
        <th width="17%" bgcolor="#000000" class="style23" scope="col"><span class="style23">Contact</span></th>
      </tr>
    </table>
  </div>
  <div id="apDiv3">
...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','917','height','311','src','../../../animation/Movie1','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../../animation/Movie1' ); //end AC code
  ...
  <div id="apDiv15">
    <div id="apDiv16">
      <table width="100%" border="0">
        <tr>
          <th colspan="2" bgcolor="#000000" scope="col" class="style22"><span class="style23">Contact</span></th>
        </tr>
        <tr>
          ...
          <td width="90%">
            <asp:DropDownList ID="d1" runat="server" AutoPostBack="True" 
                 Height="16px" 
                Width="128px" onselectedindexchanged="d1_SelectedIndexChanged">
