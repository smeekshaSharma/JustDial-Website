...
AC_FL_RunContent( 'codebase','http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,28,0','width','917','height','311','src','../../../animation/Movie1','quality','high','pluginspage','http://www.adobe.com/shockwave/download/download.cgi?P1_Prod_Version=ShockwaveFlash','movie','../../../animation/Movie1' ); //end AC code
  ...
  <div id="apDiv15">
    <div id="apDiv16">
      <table width="100%" border="0">
        <tr>
          <th bgcolor="#000000" scope="col"><span class="style27">Frequently Asked Questions</span>
            <asp:Label 
                  ID="Label1" runat="server" Text="Client"></asp:Label>            </th>
        </tr>
        <tr>
          <td>
              <br />
              ...
              <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
                  ...
                  SelectCommand="SELECT [ques], [ans] FROM [adminfaq] WHERE ([faq] = @faq)">
                  <SelectParameters>
                      <asp:ControlParameter ControlID="Label1" Name="faq" PropertyName="Text" 
                          Type="String" />
                  </SelectParameters>
              </asp:SqlDataSource>
            </td>
